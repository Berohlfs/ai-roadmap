...
1. Install Python on your machine using [uv](https://docs.astral.sh/uv/getting-started/installation/).
    * `uv` is the best option for both Unix-based systems and Windows. In my opinion, it is the go-to package manager for Python projects, and it can also manage your Python versions. 
